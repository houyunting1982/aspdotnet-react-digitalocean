...
const WhatGPT = () => {
    return (
        <div className='yth__whatgpt3 section__margin' id='whatgpt'>
            <div className='yth__whatgpt3-feature'>
                <Feature
                    title={"What is GPT3"}
                    text={
            ...
            <div className='yth__whatgpt3-heading'>
                <h1 className='gradient__text'>
                    The possibilities are beyond your imagination
                </h1>
                <p>Explore The Library</p>
            </div>
            <div className='yth__whatgpt3-container'>
                <Feature
                    title={"Chatbots"}
                    text={
